    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(limit_choices_to={'role': 'T'}, on_delete=django.db.models.deletion.CASCADE, related_name='tenant_notifications', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_owner', models.ForeignKey(blank=True, help_text='Used if the unit is owned directly by the management company.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.organization')),
