# Generated by Django 5.2.8 on 2026-02-06 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_tenant', models.OneToOneField(blank=True, limit_choices_to={'role': 'T'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='occupied_unit', to=settings.AUTH_USER_MODEL)),
                ('organization_owner', models.ForeignKey(blank=True, help_text='Set if unit is owned by the Developer/Mgmt Company.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.organization')),
                ('owner', models.ForeignKey(blank=True, limit_choices_to={'role': 'HO'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_units', to=settings.AUTH_USER_MODEL)),
